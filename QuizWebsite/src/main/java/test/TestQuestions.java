...
public class TestQuestions extends TestCase {
    ...
    public void testMultiple() {
        MultipleQuestion question = new MultipleQuestion("who was persident of us in 1987?");
    ...
    public void testSingle() {
        Question question = new SingleQuestion("What is the capital of us?");
    ...
    public void testPicture() {
        PictureQuestion question = new PictureQuestion("name this molecule",
        ...
        PictureQuestion question1 = new PictureQuestion("https://img.freepik.com/free-photo/white-horse-runs-beach_1340-34263.jpg?w=2000");
